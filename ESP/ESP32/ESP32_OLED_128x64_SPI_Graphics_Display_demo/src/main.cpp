...
// Define variables as constants, and values for ESP32 SPI GPIO pins, for pinout see: https://esp32io.com/
// Could also use e.g. #define OLED_MOSI 23 but the value could be changed by the program.
const int OLED_MOSI = 23;
const int OLED_CLK = 18;
const int OLED_DC = 16;
const int OLED_CS = 5;
const int OLED_RESET = 17;

// Note in PIO all functions must be forward declared before the setup() and loop()
void AllPixels();
void TextDisplay();
