...
//void LiquidCrystal_I2C((int, int, int, int, int, int, int, int);
...
LiquidCrystal_I2C lcd(0x3F,2,1,0,4,5,6,7);      //0x3F is the address of my LCD with I2C bus module
...
void fanControl (void) {
    ...
    if (temp < tempMin) {                                    //is temperature lower than really cold always turn off fan
        fanSpeed = 0;
        digitalWrite(fan, LOW);                          //then fan turned off
    }
